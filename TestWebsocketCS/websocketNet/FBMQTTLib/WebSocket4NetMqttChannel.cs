...
namespace MQTTnet.Extensions.WebSocket4Net
{
    public sealed class WebSocket4NetMqttChannel : IMqttChannel
    {
        ...
        public async Task ConnectAsync(CancellationToken cancellationToken)
        {
            ...
            HttpConnectProxy proxy = null;
            if (_webSocketOptions.ProxyOptions != null)
            {
                proxy = new HttpConnectProxy(new IPEndPoint(IPAddress.Parse("127.0.0.1"), 1081));
            ...
            _webSocket = new WebSocket(uri, subProtocol, cookies, customHeaders, userAgent, origin, webSocketVersion, null, sslProtocols, receiveBufferSize)
            {
                NoDelay = true,
                //Security =
                //{
                ...
                //},
                Proxy = (SuperSocket.ClientEngine.IProxyConnector)proxy
            };
